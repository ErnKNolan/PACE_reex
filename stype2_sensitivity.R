...
#43.74  15.4   71.9 mean(H) - mean(Ctrl)
#50.73  18.7   85.9 mean(L) - mean(Ctrl)
#7.03 -21.0   35.1 mean(L) - mean(H)   

#Interim 2
#The second quarter of schools

pace_rand2 <- imp %>% filter(schoolid %in% c("7","8","9","42","43","44","45","46","47",
